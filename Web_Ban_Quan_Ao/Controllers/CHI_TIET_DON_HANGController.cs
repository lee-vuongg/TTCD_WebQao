...
namespace Web_Ban_Quan_Ao.Controllers
{
    ...
    {
        private QuanLyBanQuan_AoEntities1 db = new QuanLyBanQuan_AoEntities1();
        ...
        {
            ViewBag.MaDH = new SelectList(db.DON_HANG, "MaDH", "Trang_thai");
        ...
        public ActionResult Create([Bind(Include = "MaCTDH,MaDH,MaSP,So_luong,Gia")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
            ...
            ViewBag.MaDH = new SelectList(db.DON_HANG, "MaDH", "Trang_thai", cHI_TIET_DON_HANG.MaDH);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaCTDH,MaDH,MaSP,So_luong,Gia")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
            if (ModelState.IsValid)
            {
