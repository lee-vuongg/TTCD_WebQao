...
namespace Web_Ban_Quan_Ao.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,Gia,So_luong,Mo_ta,Trang_thai,Image")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,Gia,So_luong,Mo_ta,Trang_thai,Image")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
