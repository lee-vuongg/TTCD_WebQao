...
namespace Web_Ban_Quan_Ao.Controllers
{
    public class QUAN_TRIController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Tai_khoan,Mat_khau,So_dien_thoai,Trang_thai")] QUAN_TRI qUAN_TRI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Tai_khoan,Mat_khau,So_dien_thoai,Trang_thai")] QUAN_TRI qUAN_TRI)
        {
            if (ModelState.IsValid)
            {
