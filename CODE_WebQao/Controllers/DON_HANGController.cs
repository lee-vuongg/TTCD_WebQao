...
namespace CODE_WebQao.Controllers
{
    public class DON_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaDH,MaKH,Ngay_dat,Trang_thai")] DON_HANG dON_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDH,MaKH,Ngay_dat,Trang_thai")] DON_HANG dON_HANG)
        {
            if (ModelState.IsValid)
            {
